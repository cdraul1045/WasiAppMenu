package pe.edu.upeu.crudmenu.ui.presentation.components.form
...
enum class MyFormKeys {
    ...
    CUI,TIPOCUI,MATERENTRE,HORAREG,MODFH,ACTIVIDADID, PU,PU_OLD, UTILIDAD, STOCK, STOCK_OLD, DESCRIPTION
}
